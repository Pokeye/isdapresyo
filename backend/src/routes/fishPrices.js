...
router.post(
  ...
  [
    ...
    body('min_price').isInt({ min: 0 }).withMessage('min_price must be a whole number').toInt(),
    body('max_price').isInt({ min: 0 }).withMessage('max_price must be a whole number').toInt(),
    body('avg_price').isInt({ min: 0 }).withMessage('avg_price must be a whole number').toInt(),
    validatePriceBands(),
